            ...
            <tr>
                <td align="center">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="card">
                        ...
                        <tr>
                            <td class="title">
                               شكرًا لمشاركتك في ملتقى استدامة للتقنيات الزراعية الثاني
                        ...
                        <tr>
                         ...
                         <tr>
                            <td class="title">
                               نشكر لك حضورك في ملتقى استدامة للتقنيات الزراعية الثاني <br> فقد كانت لمشاركتك إضافة قيمة أسهمت في إثراء الملتقى
                            </td>
                        </tr>
                    ...
                    <tr>
                        <td align="center" style="padding:10px;">
                            <table cellspacing="0" cellpadding="0" border="0" align="center">
                                <tr>
                                    <td bgcolor="#005D45" style="padding:14px 45px; border-radius:8px;">
                                        <a href="https://maps.app.goo.gl/c9mCgsnuPoLzNP7a7?g_st=ipc" target="_blank"
                                            style="color:#ffffff; font-size:16px; text-decoration:none; font-weight:bold; font-family:Tahoma, Arial, sans-serif; display:inline-block;">
                                            اضغط هنا للوصول للملتقى
                                        </a>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td align="center" style="color:#131212; font-size:16px; line-height:1.6; padding:20px;">
                            مع خالص التحايا<br>
                            <span style="font-weight:bold; font-size:18px;">فريق استدامة</span>
                        </td>
                    </tr>
