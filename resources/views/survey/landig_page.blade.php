...
<body>
    ...
    <div class="card-wrapper">
        <div class="invite-card">
            ...
            @if($registrationClosed)
                 <div class="details">
                    <p><a style="text-decoration: none;color:#0d7a41"
                            href="https://maps.app.goo.gl/MdbtcbZj6qyiNRBBA?g_st=ipc" target="_blank">الرياض - مركز
                            استدامة</a></p>
                    <p style="color: #0d7a41">18-17 سبتمبر 2025</p>
                    <p style="color: #0d7a41"> 10:00 ص – 4:00 م</p>
                </div>
            ...
            @else
                ...
                <div class="details">
                    <p style="color: #0d7a41">نشكر لكم اهتمامكم ورغبتكم في حضور ملتقى استدامة للتقنيات الزراعية</p>
                    <p style="color: #0d7a41"> ونفيدكم بأن التسجيل قد أُغلق لإكتمال العدد </p>
                    <p style="color: #0d7a41">ونتطلع لمشاركتكم في فعاليات مركز استدامة القادمة</p>
                </div>
    ...
    btn.addEventListener('click', function() {
        ...
        // الانتظار دقيقة واحدة قبل الانتقال
            window.location.href = '{{ route('estidamah.create') }}';
    });
</script>
</body>
