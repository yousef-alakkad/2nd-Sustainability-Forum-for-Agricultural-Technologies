    ...
    <div class="card-wrapper">
        <div class="invite-card">
            ...
            <h1 class="text-header">
               تقييم  ملتقى استدامة للتقنيات الزراعية الثاني <br>
            </h1>
            ...
            <div class="details">
                <p style="color: #0d7a41;font-weight: 700;font-size: x-large">تم تسجيل بياناتك بنجاح<br>
                شكراً لمشاركتك في الأستبيان</p>
