            ...
            <div class="card shadow mb-2">
                <div class="card-header py-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <h4 style="text-align:center">الموبايل</h4>
                        ...
                        <table class="table table-bordered yajra-datatable" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th>رقم الجوال</th>
                                    <th>الفئة</th>
                                    <th>رضاكم عن ملتقى</th>
                                    <th>رضاكم عن المحتوى المقدم</th>
                                    <th>ملاحظات </th>
                                    <th>تاريخ التسجيل</th>
                                    <th>الإجراء</th>
                                </tr>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                var table = $('.yajra-datatable').DataTable({
                    ...
                    ajax: "{{ route('registeredMembersSurveys') }}",
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                return (
                                    ...
                                    '<a title="حذف" class="btn btn-danger btn-sm" style="text-align:right;margin: .1rem" href="../../admin/delete/survey/' +
