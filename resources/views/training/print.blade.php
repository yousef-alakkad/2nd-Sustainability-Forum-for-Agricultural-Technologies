                    ...
                    <div class="card shadow mb-2">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <a class="btn" data-toggle="modal" data-target="#exampleModal" style="font-weight:bold;float:right;font-size:1.2rem">  المسجلين-للتدريب / طباعة البادج </a>
                            </h6>
                        </div>
                        <div class="card-body">
...
@push('script')
    ...
    $(function () {
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('registeredMembersTraining', ['approve' => 1]) }}",
            columns: [
                {data: 'name', name: 'name'},
                ...
                render: function (data, type, full, meta) {
                    ...
                    var id = full['id'];
                        return (
                            ...
                            '<a target="_blank" title="" style="text-align:center;margin:0 .1rem" class="btn btn-info btn-sm" href="../../badge-training/'+ id + '"  class="dropdown-item"> <i class="fa fa-print"></i></a>'+
                            '</div>'
                            // '</div>' +
                            // '</div>'
                        );
