  ...
  <div class="card-wrapper">
    <div class="invite-card">
      ...
      <h1 class="text-header">
        ...
        البرنامج التدريبي لتقنية زراعة الأنسجة النباتية
      </h1>
        @php
            use Carbon\Carbon;

            $closingTime = Carbon::parse('2025-09-08 12:00:00');
            $now = Carbon::now();
            $registrationClosed = $now->greaterThanOrEqualTo($closingTime);
        @endphp
      @if($registrationClosed)

        <p class="slogon">نشكر لكم اهتمامكم بالتسجيل في البرنامج التدريبي</br>
              لتقنيات زراعة الأنسجة النباتية</br>
             ونود إفادتكم بأنه تم إيقاف التسجيل نظرًا لإكتمال المقاعد المتاحة</p>

      @else
        <p class="slogon">الزراعة النسيجية .. فرص استثمارية</p>


        <div class="details">
            <p><a   style="text-decoration: none;color:#0d7a41" href="https://maps.app.goo.gl/MdbtcbZj6qyiNRBBA?g_st=ipc" target="_blank">الرياض - مركز استدامة</a></p>
            <p style="color: #0d7a41">من 14 - 18 سبتمبر 2025</p>
        </div>
   ...
   <script>
    ...
    btn.addEventListener('click', function() {
        ...
        // الانتظار دقيقة واحدة قبل الانتقال
            window.location.href = '{{ route('estidamah.training.create') }}';
    });
</script>
</body>
