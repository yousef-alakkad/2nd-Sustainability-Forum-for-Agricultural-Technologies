        ...
        <div class="col-md-12">
            <div class="card shadow-base bd-0 overflow-hidden">
                <div class="card-header">
                    ...
                    <h5 class="card-title mt-2">إحصائيات الحضور الملتقى</h5>
...
{{--                                    <td>{{$val->time}}</td>--}}
                                    ...
                                    <td style="padding-left:1rem">
                                        <a title="عرض الزوار" class="btn btn-primary btn-sm" style="margin:.1rem" href="{{ url('admin/BrowseEventAttendersReg/'.$val->date) }}">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a title="تصدير إلى إكسل" class="btn btn-success btn-sm" style="margin:.1rem" href="{{ url('admin/export/'.$val->date.'/1') }}">
