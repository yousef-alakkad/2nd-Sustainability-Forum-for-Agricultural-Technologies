            ...
            columnDefs: [
                ...
                render: function (data, type, full, meta) {
                    ...
                    var randomCode = full['code'];
                            ...
                            '<a title="حذف" class="btn btn-danger btn-sm" style="text-align:right;margin: .1rem" href="../../deleteWinner/'+ id + '" id="delete_btn" > <i class="fa fa-trash"></i></a>'
