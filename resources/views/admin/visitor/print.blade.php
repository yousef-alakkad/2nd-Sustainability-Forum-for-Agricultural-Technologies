                    ...
                    <div class="card shadow mb-2">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <a class="btn" data-toggle="modal" data-target="#exampleModal" style="font-weight:bold;float:right;font-size:1.2rem">  المسجلين-جدة  / طباعة البادج </a>
                            </h6>
                        </div>
                        <div class="card-body">
                ...
                render: function (data, type, full, meta) {
                    ...
                    var qrcode = full['qrcode'];
                        return (
                            ...
                            '<a target="_blank" title="" style="text-align:center;margin:0 .1rem" class="btn btn-info btn-sm" href="../print/printBadge/'+ code+'/'+ qrcode + '"  class="dropdown-item"> <i class="fa fa-print"></i></a>'+
                            '</div>'
                            // '</div>' +
                            // '</div>'
                        );
