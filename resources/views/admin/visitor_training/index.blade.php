                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal mt-4 pt-2" method="post" action="{{ route('visitor.store') }}"
                            ...
                            <div class="mb-2">
                                <h5>ماهي التقنيات التي تريد التعرف عليها من خلال ملتقى استدامة التقني
                                    القادم</h5>
                                <div class="checkbox-group">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="technologies[]" value="1"
                                            id="greenhouse" {{ in_array(1, old('technologies', [])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="greenhouse">تقنيات البيوت
                                            المحمية</label>
                                    </div>

                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="technologies[]" value="2"
                                            id="soilless" {{ in_array(2, old('technologies', [])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="soilless">تقنيات الزراعة
                                            بدون تربة</label>
                                    </div>

                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="technologies[]" value="3"
                                            id="vertical" {{ in_array(3, old('technologies', [])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="vertical">تقنيات الزراعة
                                            العمودية</label>
                                    </div>

                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="technologies[]" value="4"
                                            id="fertilizers" {{ in_array(4, old('technologies', [])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="fertilizers">الأسمدة
                                            وتغذية النباتات</label>
                                    </div>

                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="technologies[]"
                                            value="5" id="processing"
                                            {{ in_array(5, old('technologies', [])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="processing">الصناعات
                                            التحويلية للمخلفات الزراعية</label>
                                    </div>

                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="technologies[]"
                                            value="6" id="precision"
                                            {{ in_array(6, old('technologies', [])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="precision">الزراعة
                                            الدقيقة</label>
                                    </div>
                                </div>
                            </div>
