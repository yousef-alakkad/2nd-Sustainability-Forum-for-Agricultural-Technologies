...
{{--                            <a href="{{ url('/export-all-registered') }}" class="btn btn-success"><i class="fa fa-file-excel-o"></i></a>--}}
                            ...
                            <div class="row">
                                  ...
                                  <div class="col-md-12">
                                        <h4 style="text-align:center">نوع التسجيل </h4>
        ...
        var table = $('.yajra-datatable').DataTable({
            ...
            columnDefs: [
                ...
                render: function (data, type, full, meta) {
                    ...
                    var remember = '';
                    if (status == 14) {
                        remember = '<a title="تذكير" class="btn btn-primary btn-sm" style="text-align:right;margin: .1rem" href="../rememmber-invitation/visitors/'+ id + '" id="remmber" >  <i class="fa fa-send"></i></a>';
                            ...
                            '<a title="طباعة البادج" class="btn btn-warning btn-sm" style="text-align:right;margin: .1rem" href="../../admin/print/printBadge/'+ randomCode +'/'+code+ '" target="_blank" >  <i class="fa fa-print"></i></a>'+
                            '<a title="تعديل" target="_blank" class="btn btn-primary btn-sm" style="text-align:right;margin: .1rem" href="../../admin/edit/visitor/'+ id + '" >  <i class="fa fa-edit"></i></a>'
                            +'</div>'
                            // '</div>' +
                            // '</div>'
                        );
