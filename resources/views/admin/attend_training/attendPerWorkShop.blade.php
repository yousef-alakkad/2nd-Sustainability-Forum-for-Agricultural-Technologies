        ...
        <div class="col-md-12">
            <div class="card shadow-base bd-0 overflow-hidden">
                <div class="card-header">
                    ...
                    <h5 class="card-title mt-2">إحصائيات الحضور حسب الورشة </h5>
                        ...
                        <table  class="datatable table display responsive nowrap">
                            ...
                            @foreach ($workshos as $key => $val)
                                <tr>
                                    ...
                                    <td>{{$val->getName($val->work_shop_id)!=null?$val->getName($val->work_shop_id)->name:''}}</td>
                                    <td>{{$val->total}}</td>
                                    <td style="padding-left:1rem">
                                        <a title="عرض الزوار" class="btn btn-primary btn-sm" style="margin:.1rem" href="{{ url('admin/BrowseWorkShopAttenders/'.$val->work_shop_id) }}"> 
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a title="تصدير إلى إكسل" class="btn btn-success btn-sm" style="margin:.1rem" href="{{ url('export-workshop/'.$val->work_shop_id) }}">
