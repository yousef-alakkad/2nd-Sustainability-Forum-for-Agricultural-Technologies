            ...
            <div class="col-lg-8 col-md-10">
                <div class="card p-4" data-aos="fade-up">
                    ...
                    @else
                        ...
                        <form method="POST" action="{{ route('partner-survey.store') }}">
                            @csrf
                            ...
                            <div class="mb-3">
                                <label class="form-label">2.Contact </label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="exhibition_name_location" class="form-control"
                                    value="{{ old('exhibition_name_location') }}">
                                ...
                                @foreach (['Excellent', 'Good', 'Fair', 'Poor', 'Very Poor'] as $option)
                                    <div class="form-check">
                                        <input type="radio" name="saudi_pavilion_marketing_rating"
                                            ...
                                            {{ old('saudi_pavilion_marketing_rating') == $option ? 'checked' : '' }}>
                                ...
                                @foreach (['Yes, very much', 'Somewhat', 'Not really', 'Not at all'] as $option)
                                    <div class="form-check">
                                        <input type="radio" name="marketing_material_usefulness"
                                            value="{{ $option }}" class="form-check-input"
                                            {{ old('marketing_material_usefulness') == $option ? 'checked' : '' }}>
                                        <label class="form-check-label">{{ $option }}</label>
                                    </div>
                                @endforeach
                                ...
                                @foreach (['Yes', 'No', 'Not sure'] as $option)
                                    <div class="form-check">
                                        <input type="radio" name="marketing_helped_attract_visitors"
                                            value="{{ $option }}" class="form-check-input"
                                            {{ old('marketing_helped_attract_visitors') == $option ? 'checked' : '' }}>
                                        <label class="form-check-label">{{ $option }}</label>
                                    </div>
                                @endforeach
                            ...
                            <div class="mb-3">
                                <label class="form-label">4.Suggestions for improving marketing presence in future
                                    exhibitions:</label>
                                <textarea name="marketing_suggestions" class="form-control">{{ old('marketing_suggestions') }}</textarea>
                                ...
                                @foreach (['Excellent', 'Good', 'Fair', 'Poor'] as $option)
                                    <div class="form-check">
                                        <input type="radio" name="stand_design_rating" value="{{ $option }}"
                                            ...
                                            {{ old('stand_design_rating') == $option ? 'checked' : '' }}>
                                        <label class="form-check-label">{{ $option }}</label>
                                    </div>
                                @endforeach
                                ...
                                @foreach (['Fully', 'Partially', 'Not at all'] as $option)
                                    <div class="form-check">
                                        <input type="radio" name="stand_space_suitability"
                                            value="{{ $option }}" class="form-check-input"
                                            {{ old('stand_space_suitability') == $option ? 'checked' : '' }}>
                                        <label class="form-check-label">{{ $option }}</label>
                                    </div>
                                @endforeach
                                ...
                                @foreach (['Yes', 'Partially', 'No'] as $option)
                                    <div class="form-check">
                                        <input type="radio" name="stand_requirements_fulfilled"
                                            value="{{ $option }}" class="form-check-input"
                                            {{ old('stand_requirements_fulfilled') == $option ? 'checked' : '' }}>
                                        <label class="form-check-label">{{ $option }}</label>
                                    </div>
                                @endforeach
                            ...
                            <div class="mb-3">
                                <label class="form-label">4.Was the stand space comfortable, professional, and suitable
                                    for your needs?</label>
                                <textarea name="stand_improvement_suggestions" class="form-control">{{ old('stand_improvement_suggestions') }}</textarea>
                                ...
                                @foreach (['Excellent', 'Good', 'Fair', 'Poor'] as $option)
                                    <div class="form-check">
                                        <input type="radio" name="logistics_rating" value="{{ $option }}"
                                            class="form-check-input"
                                            {{ old('logistics_rating') == $option ? 'checked' : '' }}>
                                        <label class="form-check-label">{{ $option }}</label>
                                    </div>
                                @endforeach
                                ...
                                @foreach (['Yes', 'No', 'Partially'] as $option)
                                    <div class="form-check">
                                        <input type="radio" name="materials_delivered_on_time"
                                            value="{{ $option }}" class="form-check-input"
                                            {{ old('materials_delivered_on_time') == $option ? 'checked' : '' }}>
                                        <label class="form-check-label">{{ $option }}</label>
                                    </div>
                                @endforeach
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="logistics_issues" class="form-control">{{ old('logistics_issues') }}</textarea>
                                ...
                                @foreach (['Excellent', 'Good', 'Fair', 'Poor'] as $option)
                                    <div class="form-check">
                                        <input type="radio" name="communication_rating"
                                            value="{{ $option }}" class="form-check-input"
                                            {{ old('communication_rating') == $option ? 'checked' : '' }}>
                                        <label class="form-check-label">{{ $option }}</label>
                                    </div>
                                @endforeach
                                ...
                                @foreach (['Always', 'Sometimes', 'Rarely', 'Not at all'] as $option)
                                    <div class="form-check">
                                        <input type="radio" name="team_support_rating" value="{{ $option }}"
                                            class="form-check-input"
                                            {{ old('team_support_rating') == $option ? 'checked' : '' }}>
                                        <label class="form-check-label">{{ $option }}</label>
                                    </div>
                                @endforeach
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="support_comments" class="form-control">{{ old('support_comments') }}</textarea>
                                    ...
                                    @foreach (['Excellent', 'Good', 'Fair', 'Poor'] as $option)
                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="sales_leads_rating"
                                                value="{{ $option }}" class="form-check-input"
                                                {{ old('sales_leads_rating') == $option ? 'checked' : '' }}>
                                            <label class="form-check-label">{{ $option }}</label>
                                        </div>
                                    @endforeach
                                    ...
                                    @foreach (['Excellent', 'Good', 'Fair', 'Poor'] as $option)
                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="brand_exposure_rating"
                                                value="{{ $option }}" class="form-check-input"
                                                {{ old('brand_exposure_rating') == $option ? 'checked' : '' }}>
                                            <label class="form-check-label">{{ $option }}</label>
                                        </div>
                                    @endforeach
                                ...
                                @foreach (['Yes', 'Partially', 'No'] as $option)
                                    <div class="form-check">
                                        <input type="radio" name="business_goals_achieved"
                                            value="{{ $option }}" class="form-check-input"
                                            {{ old('business_goals_achieved') == $option ? 'checked' : '' }}>
                                        <label class="form-check-label">{{ $option }}</label>
                                    </div>
                                @endforeach
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="key_outcomes" value="{{ old('key_outcomes') }}"
                                    class="form-control">
                                @error('key_outcomes')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                <label class="form-label">1.What improvements would you recommend for future
                                    exhibitions?</label>
                                <textarea name="future_improvements" class="form-control">{{ old('future_improvements') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="additional_services" class="form-control">{{ old('additional_services') }}</textarea>
                                ...
                                @foreach (['Yes', 'Maybe', 'No'] as $option)
                                    <div class="form-check">
                                        <input type="radio" name="interested_in_future_exhibitions"
                                            value="{{ $option }}" class="form-check-input"
                                            {{ old('interested_in_future_exhibitions') == $option ? 'checked' : '' }}>
                                        <label class="form-check-label">{{ $option }}</label>
                                    </div>
                                @endforeach
                            ...
                            <div class="mb-3">
                                <label class="form-label">4.- How many MoU’s signed during the event? Rate on the scale
                                    of (1-10, 10-20)</label>
                                <input type="text" name="signed_during" value="{{ old('signed_during') }}"
                                    class="form-control" required> @error('signed_during')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
