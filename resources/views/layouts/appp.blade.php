...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('public/images/estidamah logo-01.png') }}"
        sizes="96x96" />
    <link rel="icon" type="image/svg+xml" href="{{asset('public/images/estidamah logo.svg') }}" />
