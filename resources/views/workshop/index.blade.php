            ...
            <div class="card shadow mb-2">
                <div class="card-header py-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <h4 style="text-align:center">الجوال </h4>
                            <span id="mobile"></span>
                        </div>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                var table = $('.yajra-datatable').DataTable({
                    ...
                    ajax: "{{ route('registeredMembersWorkShops') }}",
                    ...
                    buttons: [{
...

                        {
                            ...
                            action: function(e, dt, node, config) {
                                window.location.href = "/admin/create/visitor/workshop";
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                return (
                                    ...
                                    '<a title="حذف" class="btn btn-danger btn-sm" style="text-align:right;margin: .1rem" href="../../deleteMemberWorkshop/' +
                                    id + '" id="delete_btn" > <i class="fa fa-trash"></i></a>' +

                                    '<a title="طباعة البادج" class="btn btn-warning btn-sm" style="text-align:right;margin: .1rem" href="../../badge-workshop/' +
                                    randomCode + '" target="_blank" >  <i class="fa fa-print"></i></a>' +
                                     '<a title="تعديل" target="_blank" class="btn btn-info btn-sm" style="text-align:right;margin: .1rem" href="../../admin/edit/visitor/workshop/' +
