    ...
    <div class="home-desc-center">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center" style="background-color: #fff;border-radius: 20px">
                            ...
                            <div class="px-2 pb-3">
                                <div class="">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="" style="color:#170645;flex: 2;text-align: center;font-size: 14px;"></div>
                                        <div class="" style="border-top: 1px solid #000000;flex: 1"></div>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="text-center" style="background-color: #EA7224;border-color: #EA7224;
                                                padding: 20px 0;font-size: 30px;
                                                width: 100% !important;border-radius: 8px;color: #fff;">
                                            مجموع التبرعات
                                            <br>
                                            {{$sum}}
                                        </div>
                ...
                <div class="col-md-6 px-0" style="background-color: #eee;border-radius: 20px;">
                    <div class="qbox">
                        <div class="marq">
                            @foreach($members as $member)
                                <div class="item">
                                    {{ $member->show_name == 1 ? $member->name : 'فاعل خير'}}
                                    تبرع بـ
                                    {{ $member->amount }}
                                </div>
                            @endforeach
